...
var heroi =  new function(){
    ...
    this.estados[1] = new Estado(0,4 ,0,0,250, this);
    this.estados[2] = new Estado(14,18 ,1,0,250, this);
    this.estados[3] = new Estado(19,22 ,1,0,500, this);
...
function acertaJanela(){
    ...
    }else if(heroi.agente.x-fundo.sx>0){
        fundo.sx = heroi.agente.x;
    }
}
