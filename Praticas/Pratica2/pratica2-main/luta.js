...
var lutador =  new function(){
    ...
    this.estados[2].tabelatrans[0].x=+30;
    this.estados[2].tabelatrans[0].y=00;
    this.estados[2].tabelatrans[1]= new Object();
    this.estados[2].tabelatrans[1].x=+60;
    this.estados[2].tabelatrans[1].y=00;
    this.estados[2].tabelatrans[2]= new Object();
    this.estados[2].tabelatrans[2].x=+90;
    this.estados[2].tabelatrans[2].y=00;
    this.estados[2].tabelatrans[3]= new Object();
    this.estados[2].tabelatrans[3].x=+120;
    this.estados[2].tabelatrans[3].y=00;
    this.estados[2].tabelatrans[4]= new Object();
    this.estados[2].tabelatrans[4].x=+150;
    this.estados[2].tabelatrans[4].y=00;
    this.estados[2].tabelatrans[5]= new Object();
    this.estados[2].tabelatrans[5].x=+180;
    this.estados[2].tabelatrans[5].y=00;
    this.estados[2].tabelatrans[6]= new Object();
    this.estados[2].tabelatrans[6].x=+210;
    this.estados[2].tabelatrans[6].y=00;
    this.estados[2].tabelatrans[7]= new Object();
    this.estados[2].tabelatrans[7].x=+240;
    this.estados[2].tabelatrans[7].y=00;
    this.estados[2].tabelatrans[8]= new Object();
    this.estados[2].tabelatrans[8].x=+270;
    this.estados[2].tabelatrans[8].y=00;
    this.estados[2].tabelatrans[9]= new Object();
    this.estados[2].tabelatrans[9].x=+300;
    this.estados[2].tabelatrans[9].y=00;
    this.estados[2].tabelatrans[10]= new Object();
    this.estados[2].tabelatrans[10].x=+330;
    this.estados[2].tabelatrans[10].y=00;

    this.estados[3] = new Estado(0,1,0,0,500);
    this.estados[3].tabelatrans = new Array();
    this.estados[3].tabelatrans[0]= new Object();
    this.estados[3].tabelatrans[0].x=-30;
    this.estados[3].tabelatrans[0].y=00;
    this.estados[3].tabelatrans[1]= new Object();
    this.estados[3].tabelatrans[1].x=-60;
    this.estados[3].tabelatrans[1].y=00;
    this.estados[3].tabelatrans[2]= new Object();
    this.estados[3].tabelatrans[2].x=-90;
    this.estados[3].tabelatrans[2].y=00;
    this.estados[3].tabelatrans[3]= new Object();
    this.estados[3].tabelatrans[3].x=-120;
    this.estados[3].tabelatrans[3].y=00;
    this.estados[3].tabelatrans[4]= new Object();
    this.estados[3].tabelatrans[4].x=-150;
    this.estados[3].tabelatrans[4].y=00;
    this.estados[3].tabelatrans[5]= new Object();
    this.estados[3].tabelatrans[5].x=+-180;
    this.estados[3].tabelatrans[5].y=00;
    this.estados[3].tabelatrans[6]= new Object();
    this.estados[3].tabelatrans[6].x=-210;
    this.estados[3].tabelatrans[6].y=00;
    this.estados[3].tabelatrans[7]= new Object();
    this.estados[3].tabelatrans[7].x=-240;
    this.estados[3].tabelatrans[7].y=00;
    this.estados[3].tabelatrans[8]= new Object();
    this.estados[3].tabelatrans[8].x=-270;
    this.estados[3].tabelatrans[8].y=00;
    this.estados[3].tabelatrans[9]= new Object();
    this.estados[3].tabelatrans[9].x=-300;
    this.estados[3].tabelatrans[9].y=00;
    this.estados[3].tabelatrans[10]= new Object();
    this.estados[3].tabelatrans[10].x=-330;
    this.estados[3].tabelatrans[10].y=00;
